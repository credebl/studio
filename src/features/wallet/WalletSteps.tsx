      ...
      <li className="mb-10 ml-6">
        {props.steps > 1 ? (
          ...
          <span className="absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-900">
            <svg
              aria-hidden="true"
              className="fill-primary-650 h-8 w-8 animate-spin text-gray-200 dark:text-gray-600"
              viewBox="0 0 100 101"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <span className="absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-900 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-900"></span>
        )}
