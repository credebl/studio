      ...
      <div>
        <ul className="flex gap-4">
          {steps.map((step, index) => {
            ...
            const baseClasses =
              'flex w-full flex-col py-2 pl-4 md:border-t-4 md:border-l-0 md:pt-4 md:pb-0 md:pl-0'
            let containerClasses = ''
            let idClasses = 'text-sm font-medium'
            const nameClasses = 'text-sm font-medium'

            if (isCompleted) {
              containerClasses = `group border-l-4 border-sky-600 transition-colors ${baseClasses}`
              idClasses += ' text-sky-600 transition-colors'
            } else if (isCurrent) {
              containerClasses = `border-l-4 border-sky-600 ${baseClasses}`
              idClasses += ' text-sky-600'
            } else {
              containerClasses = `group border-l-4 border-gray-200 transition-colors h-full ${baseClasses}`
              idClasses += ' text-gray-500 transition-colors'
            }
            ...
            return (
              <li key={step.name} className="md:flex-1">
                ...
                >
                  <span className={idClasses}>{step.id}</span>
