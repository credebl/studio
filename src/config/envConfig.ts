...
const { PUBLIC_BASE_URL, PUBLIC_ALLOW_DOMAIN, PUBLIC_WMC_BASE_URL, PUBLIC_CRYPTO_PRIVATE_KEY, PUBLIC_SHOW_NAME_AS_LOGO, PUBLIC_PLATFORM_NAME, PUBLIC_PLATFORM_LOGO, PUBLIC_POWERED_BY, PUBLIC_PLATFORM_WEB_URL, PUBLIC_POWERED_BY_URL, PUBLIC_PLATFORM_DOCS_URL, PUBLIC_PLATFORM_GIT, PUBLIC_PLATFORM_SUPPORT_EMAIL, PUBLIC_PLATFORM_TWITTER_URL, PUBLIC_PLATFORM_SUPPORT_INVITE, PUBLIC_PLATFORM_DISCORD_URL }: any = envVariables;
...
export const envConfig = {
	...
	PUBLIC_WMC_BASE_URL:
		PUBLIC_WMC_BASE_URL ||
		import.meta.env.PUBLIC_WMC_BASE_URL,
