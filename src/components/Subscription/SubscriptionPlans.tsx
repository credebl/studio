        ...
        <section className="pt-2 px-4">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div className="flex flex-col justify-between p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border-t-8 border-white  shadow-[0_0_7px_0px] shadow-gray-300 dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <a href="#" className="mt-auto text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Buy Plan</a>
                    </div>

                    <div className="flex flex-col justify-between p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border-t-8 border-primary-700 shadow dark:border-gray-600  shadow-[0_0_7px_0px] shadow-gray-300 xl:p-8 dark:bg-gray-800 dark:text-white">
