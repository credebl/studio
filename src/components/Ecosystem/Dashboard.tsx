			...
			{ecosystemDetails ? (
				<div>
					{isEcosystemLead ? (
						...
						<>
							<div
								className={`mt-4 relative flex flex-wrap items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 flex`}
							>
								...
								<div className="w-full word-break-word">
									<h3 className="mb-1 text-xl font-bold text-gray-900 dark:text-white">
										{ecosystemDetails?.name}
									</h3>
									<p className="mb-1 text-base font-normal text-gray-900 dark:text-white">
					...
					>
						<div
							className={`flex relative flex-wrap ${!isEcosystemLead ? 'w-full items-start' : 'items-center'
								}`}
						>
							<div className="mr-4">
								{ecosystemDetails?.logoUrl ? (
