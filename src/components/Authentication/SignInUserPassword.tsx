							...
							<div className="flex items-center justify-center p-6 sm:p-12 md:w-2/5 ">
								<div className="w-full">
									...
									<div className='flex'>
											...
											<button className='flex lg:mt-20 mt-12' onClick={handleBackButtonClick} >
											...
											<div className='lg:mt-20 sm:mt-12 lg:mb-20 w-full'>
											...
											<Form className="space-y-6" onSubmit={formikHandlers.handleSubmit}>
												...
												<div>
													<Button
														...
														className='w-full mt-20 font-medium text-center text-white bg-primary-700 hover:!bg-primary-800 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800'
													>
