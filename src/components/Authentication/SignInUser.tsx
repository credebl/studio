							...
							<div className="flex items-center justify-center p-6 sm:p-12 md:w-2/5 ">
								<div className="w-full">
									...
									<div className='flex'>
										...
										<button className='flex lg:mt-20 mt-12' onClick={redirectLandingPage} >
										...
										<div className='lg:mt-20 sm:mt-12 lg:mb-16 w-full'>
										...
										{(formikHandlers): JSX.Element => (
											<Form className="mt-8 space-y-6" onSubmit={formikHandlers.handleSubmit}>
												<div className="text-primary-700 font-inter text-base font-medium leading-5 mt-18 mb-20">
													...
													<div className="w-full flex items-center bg-gray-200 px-4 text-gray-900 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600">
														<svg
