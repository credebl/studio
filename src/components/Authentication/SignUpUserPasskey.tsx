                                ...
                                <div className="flex flex-col items-center gap-4 mt-8">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 39 39" fill="none">
                                            ...
                                            <path d="M24.9868 17.9689V14.5625H8.5" stroke="#1F4EAD" strokeWidth="1.5" strokeMiterlimit="10" />
                                            <path d="M22.1118 10.8079C22.1118 5.40476 18.0309 1 13.025 1C8.01912 1 3.88382 5.40476 3.88382 10.8079V14.5667H1V38H24.9956V34.1238" stroke="#1F4EAD" strokeWidth="1.5" strokeMiterlimit="10" />
                                        </svg>
