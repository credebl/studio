    ...
    <div className='h-full'>
{
    ...
    <div className="bg-white flex-shrink-0">
        <div className="flex flex-col md:flex-row">
            <div className="flex justify-center px-20 py-20 md:w-3/5 bg-blue-500 bg-opacity-10" >
                <img
            ...
            <div className="flex items-center justify-center p-6 sm:p-12 md:w-2/5 ">
                <div className="w-full">
                    ...
                    <div className="mt-24 mb-24 flex justify-center mb-4 text-center text-primary-700 text-blue-600 font-inter text-4xl font-bold leading-10 ">
                        Congratulations!
                    </div>
