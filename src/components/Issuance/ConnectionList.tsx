					...
					data: [{
						data: <div className="flex items-center">
							<input id="default-checkbox" type="radio" name='connection' onClick={(event: React.MouseEvent<HTMLInputElement>) => {
								...
								value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded:full focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 cursor-pointer" />
						</div>
					},
