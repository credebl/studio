    ...
    return (
        <>
            {schemaCredDefList.map((item) => (
                <div key={Object.values(item)[2]} className="flex justify-start ml-2 w-full mt-6 overflow-scroll">
                    <div className="w-full">
                        <div className="flex flex-start mb-2 w-full ">
                            ...
                            <div className="w-9/12 m-1 flex justify-start truncate text-gray-600 dark:text-white items-center cursor-pointer overflow-auto"
                                 style={{overflow: 'auto'}}>
                        ...
                        {Object.values(item)[1] ? (
                            <div className="flex flex-start mb-2 w-full ">
                                ...
                                <div className="w-9/12 m-1 flex justify-start truncate text-gray-600 dark:text-white items-center overflow-auto">
                                    {Object.values(item)[1]
                                        ? Object.values(item)[1]
                                        : ''}
                                </div>
