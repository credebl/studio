	...
	return (
		<><div className="px-4 pt-2">
			...
			{loading ?
				...
				:
				<SummaryCard schemaId={schemaDetails.schemaId} schemaName={schemaDetails.schemaName} version={schemaDetails.schemaName} credDefId={schemaDetails.credDefId} hideCredDefId={true} />
			}
			{
