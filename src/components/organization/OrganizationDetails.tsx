                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="inline-flex min-w-0">
                                        ...
                                        <p
                                            className="ml-4 text-base font-semibold text-gray-900 truncate dark:text-white w-40 md:w-32 lg:w-80"
                                        >
                                            {agentData?.createDateTime ? <DateTooltip date={agentData?.createDateTime}> { dateConversion(agentData?.createDateTime) } </DateTooltip> : <DateTooltip date={agentData?.createDateTime}> { dateConversion(new Date().toISOString()) } </DateTooltip>}
