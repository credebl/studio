...
const WalletSpinup = (
    props: {setWalletSpinupStatus: (flag:boolean) => void}
    ) => {
...
const WalletSteps = (props: { steps: number, agentSpinupCall: boolean }) => (
 ...
 {
                props.steps === 1 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
            ...
            <h3 className="font-medium leading-tight">Agent spinup process initiated</h3>
            <p className="text-sm">Step details here</p>
        </li>
        <li className="mb-10 ml-6">
            {
                props.steps === 2 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                    <svg className="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                    </svg>
                </span>
            ...
            <h3 className="font-medium leading-tight">Agent spinup process completed</h3>
            <p className="text-sm">Step details here</p>
        </li>
        <li className="mb-10 ml-6">
            {
                props.steps === 3 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                    <svg className="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                    </svg>
                </span>
            ...
            <h3 className="font-medium leading-tight">Did publish process initiated</h3>
            <p className="text-sm">Step details here</p>
        </li>
        <li className="mb-10 ml-6">
            {
                props.steps === 4 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                    <svg className="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                    </svg>
                </span>
            ...
            <h3 className="font-medium leading-tight">Did publish process completed</h3>
            <p className="text-sm">Step details here</p>
        </li>
        <li className="mb-10 ml-6">
            {
                props.steps === 5 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                    <svg className="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                    </svg>
                </span>
            ...
            <h3 className="font-medium leading-tight">Invitation url creation started</h3>
            <p className="text-sm">Step details here</p>
        </li>
        <li className="ml-6">
            {
                props.steps === 6 && <span className="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                    <svg className="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                    </svg>
                </span>
            ...
            <h3 className="font-medium leading-tight">Invitation url creation success</h3>
            <p className="text-sm">Step details here</p>
        </li>
    </ol>
)
