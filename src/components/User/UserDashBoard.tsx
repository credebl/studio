...
const UserDashBoard = () => {
	...
	return (
		<div className="px-4 pt-6">
			...
			<div className="grid w-full grid-cols-1 gap-4 mt-0 mb-4 xl:grid-cols-2">
				<div className=" justify-between p-4 bg-white border border-gray-200 rounded-md shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
					<div className="w-full">
						...
						{organizationsList && organizationsList?.length > 0 && (
							<a
								href="/organizations"
								className="float-right inline-flex items-center text-sm font-medium rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700"
							>
								View All
							</a>
						)}
				...
				<div className="justify-between p-4 bg-white border border-gray-200 rounded-md shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
					<div className="w-full">
						...
						<h1 className="w-100 mt-8 text-center p-2 text-xl font-medium rounded-lg text-primary-700 dark:text-primary-500 dark:hover:bg-gray-700">
							Coming Soon..
						</h1>
					</div>
				</div>
