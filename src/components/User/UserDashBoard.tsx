...
const UserDashBoard = () => {
	...
	console.log('schemaList1212', schemaList);
	console.log('1212', organizationsList);
	...
	const getSchemaList = async (
		...
		try {
			...
			if (data?.statusCode === apiStatusCodes.API_STATUS_SUCCESS) {
				if (data?.data?.data) {
					setSchemaCount(data?.data?.data?.length);
		...
		try {
			...
			if (orgId) {
				...
				if (data?.statusCode === apiStatusCodes.API_STATUS_SUCCESS) {
					...
					console.log('credentialDefs', data.data);
	...
	const goToSchemaCredDef = async (schemaId: string) => {
		// await setToLocalStorage(storageKeys.ORG_ID, orgId);
		console.log('schemaId11', schemaId);
	...
	return (
		<div className="px-4 pt-6">
			...
			>
				<div className="xl:col-span-2 justify-between p-4 bg-white border border-gray-200 rounded-md shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
											...
											<div className="flex space-x-3 items-center ">
												...
												>
													...
													<button
														...
														className="hover:bg-secondary-700 p-1 rounded-md"
													>
														<svg
															xmlns="http://www.w3.org/2000/svg"
															width="24"
				...
				<div className="min-h-80 xl:col-span-1 justify-between p-4 bg-white border border-gray-200 rounded-md shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
					<div className="w-full relative">
						<div className="flex justify-between pb-2 flex text-center">
							<div className="flex text-center justify-center">
								<h2 className="text-xl font-semibold text-gray-900 dark:text-white items-center ">
			...
			<div
				...
				style={{ minHeight: '300px' }}
			>
				<div className="min-h-80 xl:col-span-2 justify-between p-4 bg-white border border-gray-200 rounded-md shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
					<div className="w-full relative">
						<div className="flex justify-between pb-2 flex text-center">
							<div className="flex text-center justify-center">
								<h2 className="text-xl font-semibold text-gray-900 dark:text-white items-center ">
								...
								{credDefList?.map((cred) => {
									return (
										...
										>
											...
											{/* <div className="min-w-6 flex space-x-3 items-center justify-start">
										<span className='truncate'>{cred?.credentialDefinitionId}</span>
									</div> */}
										</button>
									);
								})}
