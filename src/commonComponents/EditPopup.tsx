      ...
      <div className="relative p-2 text-center bg-white rounded-lg shadow dark:bg-gray-800 pr-5 pl-5">
        ...
        >
          ...
          <Button
            ...
            className="text-base font-medium text-center text-gray-900 bg-primary-700 hover:!bg-primary-100 bg-white border border-gray-300 rounded-lg focus:ring-4 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:!bg-gray-600"
          >
            No, cancel
          </Button>
          <Button
