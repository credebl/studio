...
const PasskeyAlert =()=>{
    return (
            ...
            <div className="mt-4 flex">
                <Alert color="warning" className='flex pb-0 pr-2 pl-2 pt-2'>
                    <div className='flex'>
                    <svg width="25px" height="25px" className='pb-2
                    ' viewBox="0 0 24 24" xmlns:rdf="https://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="https://www.w3.org/2000/svg" version="1.1" xmlns:cc="https://creativecommons.org/ns#" xmlns:dc="https://purl.org/dc/elements/1.1/">
