...
const CustomQRCode = ({ value, size }: { value: string, size: number }) => {
	...
	return (<div className="h-auto max-w-64 w-full flex flex-col items-center">
		...
		<Button
			...
			className='mt-4 float-right text-base font-medium text-center text-white bg-primary-700 hover:!bg-primary-800 rounded-lg hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-700 dark:hover:bg-primary-700 dark:focus:ring-primary-800'

		><svg className='pr-2' xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 24 23">
