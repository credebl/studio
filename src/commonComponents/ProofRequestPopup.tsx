	...
	return (
		<Modal show={props.openModal} size="2xl">
			<div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
				...
				<p className="font-lg m-1 p-1">
						{' '}
						Please review the attribute result before you confirm the
						verification
					</p>
					{
						!props.userData ? 
							...
							<div className="flex justify-start ml-2 w-full">
								<div key={index} className="w-full">
									<div className="flex flex-start border mb-2 w-full ">
										...
										<div className="w-8/12 bg-cyan-100 m-1 p-1 flex-start items-center text-green-900">
											{' '}
									...
									{Object.values(item)[1] ? (
										<div className="flex flex-start border mb-2 w-full ">
											...
											<div className=" w-8/12 bg-cyan-100 m-1 flrx flex-start p-1 items-center flex-wrap text-green-900">
