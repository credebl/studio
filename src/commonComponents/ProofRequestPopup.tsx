						...
						<div className="sm:p-2 lg:p-6 m-4">
							...
							{!props.userData ? (
								...
								<div className=" text-gray-500 dark:text-gray-300 w-full">
									<div className="mt-1">
										<Card >
											<div className="flex h-full flex-col justify-center gap-0 sm:p-0 lg:p-6">
											<div className="flex border-b pb-2 ">
												<div className="w-5.5/12 font-semibold flex justify-start truncate md:pl-1 sm:mr-8 md:mr-0 text-primary-700 dark:bg-gray-800 text-xl">
													Attributes
												</div>
												...
												<div className="w-5.5/12 font-semibold flex justify-start lg:pl-16 truncate sm:pl-4 text-primary-700 dark:bg-gray-800 text-xl">
													{' '}
													Values
												</div>
											</div>
