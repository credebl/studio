...
export default function PublicNavbar({ limitedWidth }: Props) {
	const navbarClass = `bg-white dark:bg-gray-900 w-full z-20 top-0 left-0 border-gray-200 dark:border-gray-600`;
	return (
		<div>
			<nav className={navbarClass}>
				<div
					className={`w-full mx-auto flex flex-wrap items-center p-4 lg:pl-12 mx-auto ${
						limitedWidth ? 'max-w-screen-xl' : ''
					}`}
				>
					<button
					...
					<div className="flex md:order-2 ml-auto flex mt-4 space-x-6 justify-center items-center">
					<a
							href="https://github.com/credebl"
							className="hidden md:block"
					>
							<svg
								className="w-6 h-6 text-gray-700 hover:text-gray-800"
								xmlns="http://www.w3.org/2000/svg"
								fill="currentColor"
								viewBox="0 0 20 20"
							>
						...
						<a
							...
							className="ml-3 hover:bg-secondary-700 bg-transparent ring-2 text-black font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:text-primary-700"
						>
							Sign in
						</a>
						<a
