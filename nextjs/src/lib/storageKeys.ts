...
export const { clearSelectedUser, setSelectedUser, setW3cSchemaData, setSchemaDetails, setAllSchema, setOrgDid, setCredDefId, setSchemaAttr, setSchemaId, clearStorage, setSelectedConnection, clearSelectedConnection } = storageKeys.actions;
