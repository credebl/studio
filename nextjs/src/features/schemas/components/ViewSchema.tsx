...
import { CredDeffFieldNameType } from '../type/schemas-interface';
    ...
    <div className='px-4 pt-2'>
      ...
      <div className='rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 2xl:col-span-2 dark:border-gray-700 dark:bg-gray-800'>
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6'>
            ...
            {loading ? (
              ...
              >
                <div className='mb-1 flex flex-wrap items-center justify-between'>
                  <h5 className='w-fit pt-1 pb-2 text-xl leading-none font-bold text-gray-900 dark:text-white'>
                    Schema Details
                  </h5>
                  <div className='w-fit p-2 lg:mt-0'>
                    <Button
                      ...
                      className='bg-secondary-700 ring-primary-700 bg-white-700 hover:bg-secondary-700 dark:hover:bg-primary-50 mr-2 mb-2 ml-auto h-[1.5rem] min-w-[11rem] rounded-lg py-0 text-sm font-medium text-black ring-2 dark:text-white dark:hover:text-black'
                      onClick={() =>
                  ...
                  <ul className='divide-y divide-gray-200 dark:divide-gray-700'>
                    <li className='pt-3 sm:pt-4'>
                      <div className='flex items-center space-x-4'>
                        <div className='inline-flex flex-wrap items-center p-1 text-base font-semibold text-gray-900 dark:text-white'>
                          Attributes:
                            ...
                            schemaDetails?.schema?.attrNames.map(
                              (element: string) => (
                                <span
                                  ...
                                  className='m-1 mr-2 rounded bg-blue-100 px-2.5 py-0.5 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300'
                                >
                                  {' '}
                                  {element}
                                </span>
          ...
          <Card
            className='overflow-hidden p-2 overflow-ellipsis'
            style={{ overflow: 'auto' }}
                      ...
                      {createloader && (
                        <div className='ml-auto'>
                          <p className='ml-5 text-sm text-gray-500 italic'>
                            <svg
                              className='mr-1 inline-block h-4 w-4 animate-spin text-blue-600'
                              xmlns='http://www.w3.org/2000/svg'
                              fill='none'
                              viewBox='0 0 24 24'
                            >
      ...
      <h5 className='p-4 text-xl leading-none font-bold text-gray-900 dark:text-white'>
        Credential Definitions
      </h5>

      {loading ? (
        <div className='mb-4 flex items-center justify-center'>Loading</div>
        ...
        >
          ...
          {currentPage.total > 1 && (
            <Pagination className='mt-6'>
              ...
              <PaginationContent>
                {Array.from({ length: currentPage.total }).map((_, index) => (
