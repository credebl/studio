    ...
    <div>
      {!props.view ? (
        <Modal
          ...
          description='Please review the verification details below.'
        >
          <div className='relative rounded-lg bg-white p-4 text-center shadow sm:p-5 dark:bg-gray-800'>
            ...
            <div className='m-4 sm:p-2 lg:p-6'>
              ...
              {props.verifyLoading ? (
                ...
                <div className='w-full text-gray-500 dark:text-gray-300'>
                  <div className='mt-1'>
                    <AttributesListData
            ...
            <div className='flex items-center justify-center space-x-4'>
              ...
              <Button
                ...
                className='medium bg-primary-700 hover:!bg-primary-800 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 rounded-lg px-2 py-1 text-center text-white focus:ring-4'
