...
const ProofRequest = (props: IProofRrquestDetails): JSX.Element => {
  ...
  const userData = props?.userData as UserDataEntry[]

  const aggregatedData: AggregatedEntry[] = []
  userData?.forEach((item: UserDataEntry): void => {
          ...
          <div className="relative m-5 rounded-lg p-4 text-center shadow sm:p-5">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Button
                ...
                className="medium bg-primary hover:bg-primary focus:ring-primary dark:bg-primary dark:hover:bg-primary dark:focus:ring-primary rounded-lg px-2 py-1 text-center focus:ring-4"
                style={{ height: '2.5rem', minWidth: '100px' }}
              >
                Close
              </Button>
