						...
						<div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0 sm:space-x-4 p-3">
							...
							<div className="sm:w-auto flex sm:flex-row space-y-2 sm:space-y-0 items-stretch sm:items-center justify-end sm:space-x-3 flex-shrink-0">
								{isRefresh && (
									<button
										onClick={refresh}
										className="p-4 focus:z-10 bg-white-700 rounded-lg mr-4 sm:mr-0 items-center mt-2 sm:mt-0"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="32"
								...
								{isSort && (
									<div className="flex items-center space-x-3 w-full sm:w-auto">
										<select
											id="small"
											className="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-450 focus:border-primary-450 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-450 dark:focus:border-primary-450"
											name="selectedValue"
											value={selectedValue}
											...
											{displaySelect ||
												(showBtn && (
													<button
														...
														type="button"
														className="text-center mt-2 text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-250 dark:focus:ring-primary-850 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
													>
														Select
													</button>
												))}
