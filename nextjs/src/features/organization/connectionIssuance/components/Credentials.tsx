...
import { DidMethod, Features, IssueCredential, IssueCredentialUserText } from '@/common/enums';
import { IConnectionListAPIParameter, getIssuedCredentials } from '@/app/api/Issuance';
										...
										data: (
											<span
												className={` ${issuedCredential.state ===
													...
													'bg-sky-300 text-primary-900 border border-sky-100 dark:border-sky-700 dark:bg-gray-700 dark:text-sky-500'
