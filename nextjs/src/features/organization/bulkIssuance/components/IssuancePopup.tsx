...
const IssuancePopup = (props: IProps) => {
	return (
		<Modal title="Test" description="desc" isOpen={props.openModal} onClose={()=>{console.log("close")}}>
				...
				<div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
					...
					<div className="p-6 text-center">
						<svg
							...
							fill="currentColor"
							viewBox="0 0 208 140"
							className='m-auto text-primary-700 stroke-custom-900'
						>
							<g filter="url(#a)">
								<ellipse
									cx="103.989"
						...
						<p className="text-3xl text-primary-900 dark:text-primary-700 mb-4">Confirmation</p>
						...
						<div className="flex justify-center">
							...
							<Button
								...
								className="bg-primary-700 hover:!bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-900 rounded-lg inline-flex items-center text-center ml-2 text-custom-900"
							>  
