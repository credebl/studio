// app/organization/delete/page.tsx
'use client';
...
export default function DeleteOrganizationPage() {
  ...
  console.log("🚀 ~ DeleteOrganizationPage ~ orgData:", orgData)
  ...
  return (
    <div className='px-4 pt-2'>
      <h1 className='mt-2 mr-auto mb-4 ml-1 text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white'>
        Delete Organization
      </h1>
