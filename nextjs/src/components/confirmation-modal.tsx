  ...
  return (
    <Dialog open={openModal} onOpenChange={(open) => closeModal(!open)}>
      <DialogContent className="relative w-full max-w-xl max-h-[450px]">
        ...
        <DialogFooter className="mt-4 flex gap-4 items-center justify-around">
          <Button
            variant="outline"
          ...
          <Button
            ...
            className={`sm:min-w-[197px] text-md font-medium rounded-lg inline-flex items-center text-center ${isProcessing ? 'opacity-70' : ''}`}
          >
            {isProcessing ? (
