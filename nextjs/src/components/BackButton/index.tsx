  ...
  return (
    <div>
      <Button
        ...
        className='bg-secondary-700 ring-primary-700 bg-white-700 hover:bg-secondary-700 rounded-lg text-sm font-medium text-black ring-2 dark:text-white dark:hover:text-black'
