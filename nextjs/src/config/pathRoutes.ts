...
export const pathRoutes = {
	...
	organizations: {
		...
		verification: {
			...
			email: '/organizations/verification/verify-credentials/schemas',
			...
			w3cAttributes: '/organizations/verification/verify-credentials/schemas/attributes',
			attributes: '/organizations/verification/verify-credentials/schemas/cred-defs/attributes',
			emailVerification: '/organizations/verification/verify-credentials/schemas/cred-defs/attributes/verification-email',
			w3cEmailVerification: '/organizations/verification/verify-credentials/schemas/attributes/verification-email',
